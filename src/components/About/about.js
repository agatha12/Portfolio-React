    ...
    return (
        <div>
            ...
            <Row id="about">
                ...
                <p id="shedPlug">Shedrick Pelt <a target="blank" href="https://www.sdotpdotmedia.com">sdotpdotmedia.com</a> social media: @sdotpdotmedia</p>

                </div>
                
                    <CardPanel className="cyan darken-4">
